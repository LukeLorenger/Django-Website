...
class PostListView(ListView):
	...
	# give us pagination functionality, number of posts shown per page
	paginate_by = 5
# Post based view
class UserPostListView(ListView):
	...
	# getting username from URL, if user exists, capture in user variable, else return 404
	def get_queryset(self):
		user = get_object_or_404(User, username=self.kwargs.get('username'))
		# creating list view of posts by selected user 
